...
router.get(
  ...
  passport.authenticate('google', {
    successRedirect: '/ysbpsongs', // UPDATE THIS, where do you want the client to go after you login
    failureRedirect: '/ysbpsongs', //  UPDATE THIS, where do you want the client to go if login fails
  })
);
...
router.get('/logout', function (req, res) {
  req.logout(function () {
    ...
    res.redirect('/ysbpsongs'); // <---- UPDATE THIS TO WHERE YOU WANT THE USER TO GO AFTER LOGOUT
  });
});
